...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    auto nodes=current_node->neighbors;
...
void RoutePlanner::setstart(float start_x, float start_y) {
    start_x *= 0.01;
    start_y *= 0.01;
...
void RoutePlanner::setend(float end_x, float end_y) {
    end_x *= 0.01;
    end_y *= 0.01;
